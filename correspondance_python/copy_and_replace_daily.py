...
if __name__ == "__main__":
    csv_file = "matching_rows_w_day0s.csv"
    from_year = "2020"
    to_year = "2022"
    try:
        with open(csv_file, 'r', newline='') as file:
            ...
            for row in csv_reader:
                ...
                #print(col8)
                if(int(col3)>0):
                    source_file = "C:/Users/John/Documents/GitHub/bibleplan.github.io/_posts/daily/"+year8+"/wk"+make_string_length_3(col6)+"/"+col8+"-daily.md"
                else:
                    source_file = "template-daily.md"
                    col2 = str(int(col2)-1)
                    col3 = str(7)
                    print("SUNDAY!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
                print(source_file)
                destination_file = "_posts/daily/"+year4+"/wk"+make_string_length_3(col2)+"/"+col4+"-daily.md"
                copy_file_contents(source_file, destination_file)

                find_word = "layout: daily"+year8
                replace_word = "layout: daily"+year4+"\nlanguage: Chinese"
                ...
                find_word = "第"+col6+"週 第"+col7+"天"
                replace_word = "第"+col2+"週 第"+col3+"天"
                
                find_replace_words(destination_file, find_word, replace_word)   

                find_word = "permalink: /daily/"+year8+"/wk"+col6+"-day"+col7+"-daily.html"
                replace_word = "permalink: /daily/"+year4+"/wk"+col2+"-day"+col3+"-daily.html"
